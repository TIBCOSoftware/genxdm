...
public enum SmQuantifier
{
	...
	private SmQuantifier(final int mask)
	{
		m_mask = mask;
	}

	public boolean contains(final SmQuantifier other)
	{
	 ...
	 */
	public boolean in(final SmQuantifier... others)
	{
		assertArgumentNotNull(others, "others");
		for (final SmQuantifier other : others)
		{
	...
	public SmQuantifier sum(final SmQuantifier other)
	{
		assertArgumentNotNull(other, "other");
		switch (this)
		{
	...
	public SmQuantifier choice(final SmQuantifier other)
	{
		assertArgumentNotNull(other, "other");
		switch (this)
		{
	...
	public SmQuantifier product(final SmQuantifier other)
	{
		assertArgumentNotNull(other, "other");
		switch (this)
		{
	...
	/**
	 * Approximates the schema minOccurs and maxOccurs with the {@link SmQuantifier}.
	 * 
	 * @param minOccurs
	 *            The min-occurs value.
	 * @param maxOccurs
	 *            The max-occurs value.
	 * @return The {@link SmQuantifier} approximation.
	 */
	public static SmQuantifier approximate(final int minOccurs, final int maxOccurs)
	{
		if (minOccurs == 0)
		{
			if (maxOccurs == 0)
