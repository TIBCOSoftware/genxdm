...
/**
 * SmModelGroup represents a group of content sequences. A group consists of a compositor and a list of particles. For
 ...
 */
public interface SmModelGroup<A> extends SmParticleTerm<A>, SmComponent<A>
{
	 ...
	 */
	List<SmParticle<A>> getParticles();
}
