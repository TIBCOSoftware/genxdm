...
import org.gxml.bridge.dom.axes.AxisAncestorIterable;
import org.gxml.bridge.dom.axes.AxisAncestorOrSelfIterable;
import org.gxml.bridge.dom.axes.AxisChildElementIterable;
import org.gxml.bridge.dom.axes.AxisChildIterable;
import org.gxml.bridge.dom.axes.AxisDescendantOrSelfIterable;
import org.gxml.bridge.dom.axes.AxisFollowingSiblingIterable;
import org.gxml.bridge.dom.axes.AxisPrecedingSiblingIterable;
        ...
        if (origin != null && origin instanceof Element)
        {
            ...
            if (inherit)
            {
                ...
                for (final Node scope : scopes)
                {
                    ...
                    {
                        if (nameBridge.isXmlNamespaceURI(attribute.getNamespaceURI()))
                        {
