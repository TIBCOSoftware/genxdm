...
public final class SmAtomicTypeSupport
{
	...
	public static String formatGregorianC14N(final int year, final int month, final int day, final int hour, final int minute, final int second, final BigDecimal fractionalSecond, final int timezone, final SmNativeType nativeType)
	{
