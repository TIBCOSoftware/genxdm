...
final class LongType<A> extends AbstractAtomType<A>
{
	public LongType(final QName name, final SmSimpleType<A> baseType, final AtomBridge<A> atomBridge)
	{
	...
	public List<A> validate(final String initialValue) throws SmDatatypeException
	{
		try
		{
			...
			return atomBridge.wrapAtom(atomBridge.createLong(Long.valueOf(trimmed)));
		}
