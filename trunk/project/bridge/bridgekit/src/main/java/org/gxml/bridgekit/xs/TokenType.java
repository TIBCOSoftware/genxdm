...
{
	public TokenType(final QName name, final SmSimpleType<A> baseType, final AtomBridge<A> atomBridge)
	{
	...
	{
		return atomBridge.wrapAtom(atomBridge.createStringDerived(initialValue, SmNativeType.TOKEN));
	}
