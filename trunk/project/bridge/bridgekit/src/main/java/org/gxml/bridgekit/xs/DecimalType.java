...
final class DecimalType<A> extends AbstractAtomType<A>
{
	...
	private static String scale(String value, boolean allowExponential, final SmSimpleType<?> type) throws SmDatatypeException
	{
		...
		{
			throw new SmDatatypeException(value, type);
		}
