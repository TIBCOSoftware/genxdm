...
public enum SmNativeType
{
	 ...
	 */
	public static SmNativeType computeCommonAncestorSelf(SmNativeType lhs, SmNativeType rhs, final boolean promotions)
	{
	...
	public static SmNativeType getType(final String localName)
	{
		if (localName != null)
		{
			for (final SmNativeType type : SmNativeType.values())
			{
	...
	private final SmNativeType[] m_parent = new SmNativeType[2];
	private final int[] m_depth = new int[2];

	private final QName name;

	private SmNativeType(final String localName)
	{
	 ...
	 */
	private SmNativeType(final String name, final SmNativeType parent)
	{
		this(name, parent, parent);
	}

	private SmNativeType(final String localName, final SmNativeType parent, final SmNativeType promotion)
	{
	 ...
	 */
	public Iterable<SmNativeType> getAncestorOrSelf(final boolean promotions)
	{
	 ...
	 *            The specified type.
	 */
	public boolean isA(final SmNativeType other)
	{
		if (this == other)
		{
			return true;
	 ...
	 *            The specified type.
	 */
	public boolean promotesTo(final SmNativeType other)
	{
		if (this == other)
		{
			return true;
