...
import org.gxml.xs.exceptions.SmWildcardIntersectionException;
import org.gxml.xs.exceptions.SmWildcardIntersectionNotExpressibleException;
import org.gxml.xs.exceptions.SmWildcardUnionException;
import org.gxml.xs.exceptions.SmWildcardUnionNotExpressibleException;
 ...
 */
public final class SmNamespaceConstraint
{
	public enum Mode
	{
		/**
	 ...
	 * @param nameBridge
	 */
	public static SmNamespaceConstraint Any(final NameSource nameBridge)
	{
		return new SmNamespaceConstraint(nameBridge);
	}

	private static boolean equals(final SmNamespaceConstraint one, final SmNamespaceConstraint two)
	{
		if (one == two)
		{
			return true;
	 ...
	 */
	public static SmNamespaceConstraint exclude(final String namespace, final NameSource nameBridge)
	{
		...
		{
			return new SmNamespaceConstraint(Mode.Exclude, namespace, nameBridge);
		}
	}
	 ...
	 */
	public static SmNamespaceConstraint include(final Set<String> namespaces, final NameSource nameBridge)
	{
		...
		return new SmNamespaceConstraint(Mode.Include, strings, nameBridge);
	}

	private static SmNamespaceConstraint intersectIncludeAndExclude(final SmNamespaceConstraint include, final SmNamespaceConstraint exclude, NameSource nameBridge)
	{
		...
		return new SmNamespaceConstraint(Mode.Include, namespaces, nameBridge);
	}
			...
			switch (one.m_mode)
			{
				...
				case Include:
				{
					switch (two.m_mode)
					{
						...
						case Include:
						{
							return new SmNamespaceConstraint(Mode.Include, intersection(one.m_namespaces, two.m_namespaces), nameBridge);
						}
						default:
						{
	...
	private static boolean isSubset(final SmNamespaceConstraint sub, final SmNamespaceConstraint sup, final NameSource nameBridge)
	{
	 ...
	 */
	public static SmNamespaceConstraint NotAbsent(final NameSource nameBridge)
	{
		return new SmNamespaceConstraint(Mode.Exclude, nameBridge.empty(), nameBridge);
	}
			...
			switch (one.m_mode)
			{
				...
				case Include:
				{
					switch (two.m_mode)
					{
						...
						case Include:
						{
							return new SmNamespaceConstraint(Mode.Include, union(one.m_namespaces, two.m_namespaces), nameBridge);
						}
						default:
						{
	 ...
	 */
	private SmNamespaceConstraint(final Mode mode, final HashSet<String> namespaces, final NameSource nameBridge)
	{
	 ...
	 */
	private SmNamespaceConstraint(final Mode mode, final String namespace, final NameSource nameBridge)
	{
		// Limitation imposed by current specification.
	 ...
	 */
	private SmNamespaceConstraint(final NameSource nameBridge)
	{
		m_mode = Mode.Any;
		m_namespaces = new HashSet<String>();
		m_nameBridge = nameBridge;
	...
	public boolean equals(final Object obj)
	{
		...
		else if (obj instanceof SmNamespaceConstraint)
		{
			final SmNamespaceConstraint other = (SmNamespaceConstraint)obj;
	 ...
	 *            The other namespace constraint.
	 */
	public boolean isSubset(final SmNamespaceConstraint superSet)
	{
