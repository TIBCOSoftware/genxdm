...
{
	public IDREFType(final QName name, final SimpleType<A> baseType, final AtomBridge<A> atomBridge)
	{
	...
	public List<A> validate(final String initialValue) throws DatatypeException
	{
		...
		return atomBridge.wrapAtom(atomBridge.createStringDerived(castAsIDREF(normalized, this), NativeType.IDREF));
	}

	public static String castAsIDREF(final String normalized, final SimpleType<?> type) throws DatatypeException
	{
