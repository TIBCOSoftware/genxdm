...
final class ByteType<A> extends AbstractAtomType<A>
{
	public ByteType(final QName name, final SmSimpleType<A> baseType, final AtomBridge<A> atomBridge)
	{
	...
	public List<A> validate(final String initialValue) throws SmDatatypeException
	{
		try
		{
			...
			return atomBridge.wrapAtom(atomBridge.createByte(Byte.valueOf(trimmed)));
		}
