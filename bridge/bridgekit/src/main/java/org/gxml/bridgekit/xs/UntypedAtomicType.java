...
final class UntypedAtomicType<A> extends AbstractAtomType<A>
{
	public UntypedAtomicType(final QName name, final SmSimpleType<A> baseType, final AtomBridge<A> atomBridge)
	{
	...
	{
		return SmNativeType.UNTYPED_ATOMIC;
	}
