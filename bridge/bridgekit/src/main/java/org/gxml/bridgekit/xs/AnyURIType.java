...
final class AnyURIType<A> extends AbstractAtomType<A>
{
	public AnyURIType(final QName name, final SmSimpleType<A> baseType, final AtomBridge<A> atomBridge)
	{
