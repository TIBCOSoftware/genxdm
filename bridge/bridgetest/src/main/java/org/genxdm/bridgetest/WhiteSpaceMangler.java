...
public final class WhiteSpaceMangler
{
	private WhiteSpaceMangler()
	{
	}

	/**
	 * <b>whitespace replacement</b> <br>
	 * The action of replacing all the occurrences of the characters #x9 (tab), #xA (line-feed), and #xD (carriage return) by a #x20 (space) between the parsed and the lexical space. Whitespace replacement does not change the length of the string. xs:normalizedString
	 ...
	 */
	public static String replaceWhiteSpace(final String text)
	{
	 ...
	 * The action of applying whitespace replacement, trimming the leading and trailing spaces, and replacing all the sequences of contiguous whitespace by a single space between the parsed and lexical spaces. Most of the simple datatypes apply whitespace collapsing.
	 */
