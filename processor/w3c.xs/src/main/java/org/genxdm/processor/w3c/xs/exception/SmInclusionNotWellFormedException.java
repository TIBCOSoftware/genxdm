...
{
	public SmInclusionNotWellFormedException(final SmLocation location)
	{
		super(PART_NOT_WELL_FORMED, location);
	}

	public SmInclusionNotWellFormedException(final SmLocation location, final SmException cause)
	{
