...
public final class SccMaxInclusiveAndMaxExclusiveException extends SmComponentConstraintException
{
	...
	{
		super(SmOutcome.SCC_MaxInclusiveAndMaxExclusive, "4.3.8.4");
