...
public final class SccElementDeclarationSubstitutionGroupTypeDerivationException extends SccElementDeclarationException
{
    ...
    {
        return "The {type definition} of the element declaration " + getElementName() + " must be validly derived from the type definition of the {substitution group affiliation}.";
    }
}
