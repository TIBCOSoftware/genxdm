...
{
	public IDType(final QName name, final SimpleType<A> baseType, final AtomBridge<A> atomBridge)
	{
	...
	public List<A> validate(final String initialValue) throws DatatypeException
	{
		...
		return atomBridge.wrapAtom(atomBridge.createStringDerived(castAsID(normalized, this), NativeType.ID));
	}

	public static String castAsID(final String normalized, final SimpleType<?> type) throws DatatypeException
	{
