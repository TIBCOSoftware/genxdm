...
final class Base64Codec
{
	...
	/**
	 * Warning: the supplied string must be valid base 64 (a subset of US-ASCII, correctly padded). The algorithm is
	 * forgiving about line length and line ending style, however.
	 * 
	 * @param base64
	 ...
	 * @throws IllegalArgumentException
	 *             if the String cannot be parsed as base64 (contains illegal bytes, is not padded to a multiple of four
	 *             bytes, etc).
	 */
