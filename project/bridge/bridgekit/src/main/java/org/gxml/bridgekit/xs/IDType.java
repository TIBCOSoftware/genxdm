...
final class IDType<A> extends AbstractAtomType<A>
{
	public IDType(final QName name, final SmSimpleType<A> baseType, final AtomBridge<A> atomBridge)
	{
	...
	public List<A> validate(final String initialValue) throws SmDatatypeException
	{
		...
		return atomBridge.wrapAtom(atomBridge.createStringDerived(castAsID(normalized, this), SmNativeType.ID));
	}

	public static String castAsID(final String normalized, final SmSimpleType<?> type) throws SmDatatypeException
	{
