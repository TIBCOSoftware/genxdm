...
final class Base64BinaryType<A> extends AbstractAtomType<A>
{
	public Base64BinaryType(final QName name, final SmSimpleType<A> baseType, final AtomBridge<A> atomBridge)
	{
