...
final class IDREFType<A> extends AbstractAtomType<A>
{
	public IDREFType(final QName name, final SmSimpleType<A> baseType, final AtomBridge<A> atomBridge)
	{
	...
	public List<A> validate(final String initialValue) throws SmDatatypeException
	{
		...
		return atomBridge.wrapAtom(atomBridge.createStringDerived(castAsIDREF(normalized, this), SmNativeType.IDREF));
	}

	public static String castAsIDREF(final String normalized, final SmSimpleType<?> type) throws SmDatatypeException
	{
