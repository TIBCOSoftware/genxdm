...
final class SchemaCacheImpl implements SchemaComponentCache
{
    ...
    private QName checkComponent(final SchemaComponent component, final ComponentKind kind)
    {
        ...
        if (!kind.canBeAnonymous)
            PreCondition.assertFalse(component.isAnonymous(), "component must not be anonymous");
        return PreCondition.assertNotNull(component.getName(), "name");
    }
    ...
    private class ProviderImpl implements ComponentProvider
    {
        ...
        public boolean hasElement(final QName name)
        {
            ...
            {
            	final QName testName = encodeQName(name);
            	if ( (testName != null) && m_elements.containsKey(testName))
        			return true;
            }
            return retval;
        }
        ...
        public boolean hasIdentityConstraint(final QName name)
        {
            ...
            {
            	final QName testName = encodeQName(name);
            	if ((testName != null) && m_identityConstraints.containsKey(testName))
        			return true;
            }
            return retval;
        }
        ...
        public boolean hasModelGroup(final QName name)
        {
            ...
            {
            	final QName testName = encodeQName(name);
            	if ((testName != null) && m_modelGroups.containsKey(testName))
        			return true;
            }
            return retval;
        }
        ...
        public boolean hasNotation(final QName name)
        {
            ...
            {
            	final QName testName = encodeQName(name);
            	if ((testName != null) && m_notations.containsKey(testName))
        			return true;
            }
            return retval;
        }
        ...
        public boolean hasSimpleType(final QName name)
        {
            ...
            if (!retval)
            {
            	final QName testName = encodeQName(name);
            	if ((testName != null) &&
            	    (m_complexTypes.containsKey(testName) || m_simpleTypes.containsKey(testName)) )
            		return true;
            }
            return retval;
        }
        ...
        public boolean hasType(final QName name)
        {
            if (name != null)
            {
                if (m_complexTypes.containsKey(name) || m_simpleTypes.containsKey(name))
                    return true;
                final QName testName = encodeQName(name);
                if (testName != null)
                {
                    if (m_complexTypes.containsKey(testName) || m_simpleTypes.containsKey(testName))
                        return true;
                }
            }
            return false;
