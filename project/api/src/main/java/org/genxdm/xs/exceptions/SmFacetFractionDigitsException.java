...
public final class SmFacetFractionDigitsException extends SmFacetException
{
	private final String value;
	private final SmFractionDigits<?> fractionDigits;

	public SmFacetFractionDigitsException(final String value, final SmFractionDigits<?> fractionDigits)
	{
