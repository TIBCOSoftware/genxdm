...
public class SmAtomCastException extends Exception
{
	private final QName errorCode;
	private final String sourceValue;
	private final QName targetType;

	public SmAtomCastException(final String sourceValue, final QName targetType, final QName errorCode)
	{
	...
	public SmAtomCastException(final String sourceValue, final QName targetType, final QName errorCode, final Throwable cause)
	{
		super(cause);
		this.sourceValue = PreCondition.assertArgumentNotNull(sourceValue, "sourceValue");
		this.targetType = PreCondition.assertArgumentNotNull(targetType, "targetType");
