 ...
 */
public final class SmDatatypeException extends SmException
{
	...
	public SmDatatypeException(final String literal, final SmSimpleType<?> type)
	{
		super(SmOutcome.CVC_Datatype, "?");
		this.literal = PreCondition.assertArgumentNotNull(literal, "literal");
		this.type = type;
	}

	public SmDatatypeException(final String literal, final SmSimpleType<?> type, final SmException cause)
	{
		super(SmOutcome.CVC_Datatype, "?", cause);
		this.literal = PreCondition.assertArgumentNotNull(literal, "literal");
		this.type = type;
	}
