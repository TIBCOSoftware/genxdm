...
public class SmAtomCastRuntimeException extends RuntimeException
{
	private final QName errorCode;
	private final String sourceValue;
	private final QName targetType;

	public SmAtomCastRuntimeException(final String sourceValue, final QName targetType, final QName errorCode)
	{
	...
	public SmAtomCastRuntimeException(final String sourceValue, final QName targetType, final QName errorCode, final Throwable cause)
	{
		super(cause);
		this.sourceValue = PreCondition.assertArgumentNotNull(sourceValue, "sourceValue");
		this.targetType = PreCondition.assertArgumentNotNull(targetType, "targetType");
