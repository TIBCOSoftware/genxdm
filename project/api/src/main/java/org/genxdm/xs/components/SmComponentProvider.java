...
public interface SmComponentProvider<A> extends SmComponentDetector
{
	...
	/**
	 * Returns the {@link org.genxdm.xs.components.SmAttribute} if it exists by the given name, otherwise <code>null</code>. If an
	 ...
	 * @return The {@link org.genxdm.xs.components.SmAttribute} identified by the name, or <code>null</code> if it does not exist.
	 */
	 ...
	 * @return The {@link org.genxdm.xs.components.SmAttributeGroup} identified by the name, or <code>null</code> if it does not
	 *         exist.
	 */
	...
	/**
	 * Returns the {@link org.genxdm.xs.components.SmElement} if it exists by the given name, otherwise <code>null</code>. If an
	 * error occurs, an implementation-defined unchecked exception will be thrown.
	 * 
	 * @param name
	 *            The name of the element declaration to be retrieved.
	 * @return The {@link org.genxdm.xs.components.SmElement} identified by the name, or <code>null</code> if it does not exist.
	 */
	...
	/**
	 * Returns the {@link org.genxdm.xs.components.SmModelGroup} if it exists by the given name, otherwise <code>null</code>. If an
	 * error occurs, an implementation-defined unchecked exception will be thrown.
	 * 
	 * @param name
	 *            The name of the Model Group Definition to be retrieved.
	 * @return The {@link org.genxdm.xs.components.SmModelGroup} identified by the name, or <code>null</code> if it does not exist.
	 */
	SmModelGroup<A> getModelGroup(QName name);

	/**
	 * Returns the {@link org.genxdm.xs.components.SmNotation} if it exists by the given name, otherwise <code>null</code>. If an
	 * error occurs, an implementation-defined unchecked exception will be thrown.
	 * 
	 * @param name
	 *            The name of the Notation declaration to be retrieved.
	 * @return The {@link org.genxdm.xs.components.SmNotation} identified by the name, or <code>null</code> if it does not exist.
	 */
