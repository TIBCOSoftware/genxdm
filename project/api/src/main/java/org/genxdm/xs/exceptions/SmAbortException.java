 ...
 * raising of an {@link SmException}. This exception is intentionally not-derived from {@link SmException}.
 */
@SuppressWarnings("serial")
public final class SmAbortException extends Exception
{
	public SmAbortException(final SmException cause)
	{
