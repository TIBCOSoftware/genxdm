 ...
 *            The atom handle.
 */
public interface SmComponentBag<A>
{
	/**
	 * Returns the Attribute group definitions.
	 */
	Iterable<SmAttributeGroup<A>> getAttributeGroups();

	/**
	 * Returns the Attribute declarations.
	 */
	Iterable<SmAttribute<A>> getAttributes();
	 ...
	 */
	Iterable<SmElement<A>> getElements();
	 ...
	 */
	Iterable<SmModelGroup<A>> getModelGroups();

	/**
	 * Returns the Notation declarations.
	 */
	Iterable<SmNotation<A>> getNotations();
