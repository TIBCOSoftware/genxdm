...
public final class GxmlAtomCastRuntimeException extends RuntimeException
{
	...
	public GxmlAtomCastRuntimeException(final String sourceValue, final QName sourceType, final QName targetType, final QName errorCode)
	{
	...
	public GxmlAtomCastRuntimeException(final String sourceValue, final QName sourceType, final QName targetType, final QName errorCode, final Throwable cause)
	{
		super(cause);
		this.sourceValue = PreCondition.assertArgumentNotNull(sourceValue, "sourceValue");
		this.sourceType = PreCondition.assertArgumentNotNull(sourceType, "sourceType");
